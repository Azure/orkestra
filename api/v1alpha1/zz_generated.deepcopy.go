...
func (in *DAG) DeepCopyInto(out *DAG) {
	*out = *in
	in.DAGData.DeepCopyInto(&out.DAGData)
	in.Spec.DeepCopyInto(&out.Spec)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DAGData) DeepCopyInto(out *DAGData) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DAGData.
func (in *DAGData) DeepCopy() *DAGData {
	if in == nil {
		return nil
	}
	out := new(DAGData)
