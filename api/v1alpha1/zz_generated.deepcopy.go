...
func (in *ApplicationGroupSpec) DeepCopyInto(out *ApplicationGroupSpec) {
	*out = *in
	if in.Applications != nil {
		...
		*out = make([]ApplicationsDAG, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationsDAG) DeepCopyInto(out *ApplicationsDAG) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationsDAG.
func (in *ApplicationsDAG) DeepCopy() *ApplicationsDAG {
	if in == nil {
		return nil
	}
	out := new(ApplicationsDAG)
	in.DeepCopyInto(out)
	return out
}
