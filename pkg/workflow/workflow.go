...
type Engine interface {
	...
	GenerateReverse(ctx context.Context, l logr.Logger, nodes map[string]v1alpha12.NodeStatus, g *v1alpha1.ApplicationGroup) error
	// Submit the reverse object required by the workflow engine generated by the GenerateReverse method
	SubmitReverse(ctx context.Context, l logr.Logger, g *v1alpha1.ApplicationGroup) error
}
